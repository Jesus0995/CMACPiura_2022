Feature: Registrar informe comercial nuevo con el perfil Asesor de Negocios
  ...
  @Prueba
  Scenario: Registrar informe comercial nuevo del cliente en el sistema SGCRED
    ...
    And en la ventana busqueda de clientes digitar el codigo "23286823"
    ...
    And muestra la ventana nuevo informe comercial e ingresar datos el patrimonio "20000"
