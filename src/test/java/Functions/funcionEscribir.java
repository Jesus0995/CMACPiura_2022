...
public class funcionEscribir {
    ...
    private static EnlazarEstadosFinancierosPage enlazarEstadosFinancieros;
    private static DesenlazarInformeVisitaPage desenlazarInformeVisita;
    private static EnlazarInformeVisitaPage enlazarInformeVisita;
    private static EnlazarInformeComercialNuevoPage enlazarInformeComercialNuevo;
    private static InformeEEFFConsolidadoGrupoVinculadoPage informeEEFFConsolidadoGrupoVinculado;
    private static GrabarInformacionDocumentoPage grabarPropuesta;
